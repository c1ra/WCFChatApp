...
using localClient.SerRef;
using System.Windows.Controls;

namespace localClient
{
    class TheController : SerRef.IClientCallback
    {
        ...
        private SerRef.ClientClient proxy = null;
        private int receiver;
        public Client localclient = null;
        private SerRef.GroupClient groupClient1 = null;
        ...
        public async Task<bool> ConnectAsync(string usrName, string pass)
        {
            ...
            proxy = new ClientClient(context);
